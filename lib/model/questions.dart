...
SurveySchema untetherQuestions = SurveySchema(
  questions: <SurveyQuestion>[
    SurveyQuestion(question: 'How difficult was your day?', weight: 0.15, answers: <SurveyAnswer>[
      SurveyAnswer(answer: '1 😎', pointValue: 10),
      SurveyAnswer(answer: '2 😁', pointValue: 9),
      SurveyAnswer(answer: '3 😄', pointValue: 8),
      SurveyAnswer(answer: '4 😌', pointValue: 7),
      SurveyAnswer(answer: '5 🙂', pointValue: 6),
      SurveyAnswer(answer: '6 😐', pointValue: 5),
      SurveyAnswer(answer: '7 🙃', pointValue: 4),
      SurveyAnswer(answer: '8 😞', pointValue: 3),
      SurveyAnswer(answer: '9 😠', pointValue: 2),
      SurveyAnswer(answer: '10 😡', pointValue: 1),
    ]),
